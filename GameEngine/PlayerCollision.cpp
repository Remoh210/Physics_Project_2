...
//	pPlayer->setMeshOrientationEulerAngles(glm::vec3(camera.Front.y * 2, camera.Front.x * 2, camera.Front.z * 2), false);
	...
	// *****************************************************
	//pPlayer->position.x += 0.01f;
	//pPlayer->position.y += 0.02f;
